...
# REAL RUN
python3 src/alab_release.py --min-coverage 95 --min-depth 200 --not-dry-run --out-dir /asgard/2021-11-12_release --sample-sheet /home/al/analysis/alab_release/2021-11-12_sample_tracker.csv --cpus 25 --analysis-folder /asgard/analysis/ --output-metadata /home/al/code/HCoV-19-Genomics/metadata.csv --include-bams
